    ...
    return (
      <header className="bg-[#3f4b7e] text-white border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-14 flex items-center justify-between gap-4">
          <Link to="/" className="font-['Newsreader',serif] text-xl tracking-tight hover:text-white/90 shrink-0">
            JESAM
          </Link>
  ...
  return (
    <header className="bg-[#3f4b7e] text-white border-b border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-14 flex items-center justify-between">
        <Link to="/" className="font-['Newsreader',serif] text-xl tracking-tight hover:text-white/90">
          JESAM
        </Link>
