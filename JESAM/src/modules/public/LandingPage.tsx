    ...
    <div className="min-h-screen bg-white font-['Public_Sans',sans-serif]">
      ...
      <nav className="bg-[#3f4b7e] px-6 py-4 flex justify-between items-center shadow-lg">
        <div className="flex items-center gap-4">
          ...
          <span className="font-['Newsreader',serif] text-xl text-white hidden md:block tracking-wide">
            JESAM
          </span>
        </div>
        ...
        <div className="flex items-center gap-6">
          <div className="hidden lg:flex gap-6 text-white/80 text-sm font-medium">
            <a href="/about" className="hover:text-[#F5C344] transition">
              About
            </a>
            <a href="/archive" className="hover:text-[#F5C344] transition">
              Archive
            </a>
          </div>
          <Link to="/login">
      ...
      <header className="relative bg-[#3f4b7e] py-24 px-6 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto relative z-10 text-center md:text-left">
          <h1 className="font-['Newsreader',serif] text-4xl md:text-6xl text-white mb-6 leading-tight">
            ...
            <span className="text-[#F5C344]">
              Respecting the Limits of Nature.
            </span>
          </h1>
          <p className="text-lg text-white/80 mb-10 max-w-2xl leading-relaxed">
            JESAM is the official knowledge platform of UPLB SESAM, dedicated to
            bridging scientific investigation, policy dialogue, and sustainable
            community action.
          </p>
      ...
      <div className="bg-[#f8f9fa] border-b border-slate-200">
        <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-4 py-8 px-6">
          {[
            ...
            <div
              key={i}
              className="text-center md:border-r last:border-0 border-slate-200"
            >
              <div className="text-xl font-bold text-[#3f4b7e]">
                {stat.value}
              </div>
              <div className="text-[11px] uppercase tracking-widest text-slate-500 font-bold mt-1">
                {stat.label}
              </div>
            </div>
          ))}
      ...
      <main className="max-w-6xl mx-auto py-20 px-6 grid grid-cols-1 lg:grid-cols-3 gap-16">
        <div className="lg:col-span-2">
          <div className="flex items-center gap-3 mb-10">
            ...
            <h2 className="font-['Newsreader',serif] text-3xl text-[#3f4b7e]">
              Latest Publications
            </h2>
          </div>
          ...
          <div className="space-y-12">
            {[1, 2, 3].map((i) => (
              <div key={i} className="group cursor-pointer">
                <div className="text-[#F5C344] text-xs font-bold mb-2 tracking-widest uppercase">
                  Research Article • Vol 24, Issue 2
                </div>
                <h3 className="font-['Newsreader',serif] text-2xl text-[#3f4b7e] group-hover:underline mb-3">
                  Analysis of Biodiversity Conservation in the Makiling Forest
                  Reserve
                </h3>
                <p className="text-slate-600 text-sm mb-4 line-clamp-2">
                  This study investigates the anthropogenic factors affecting
                  the flora and fauna within the protected zones...
                </p>
        ...
        <aside className="space-y-12">
          <div className="p-8 bg-[#3f4b7e] rounded-xl text-white shadow-xl shadow-[#3f4b7e]/20">
            <h3 className="font-['Newsreader',serif] text-xl mb-4 text-[#F5C344]">
              For Reviewers
            </h3>
            <p className="text-sm text-white/70 mb-6 leading-relaxed">
              Help us maintain the highest scientific standards. Join our panel
              of expert reviewers.
            </p>
          ...
          <div>
            <h3 className="font-bold text-slate-900 mb-6 flex items-center gap-2 uppercase text-xs tracking-widest">
              <TrendingUp className="w-4 h-4 text-[#F5C344]" /> Trending
              Knowledge
            </h3>
            <div className="flex flex-wrap gap-2">
              {[
                ...
                <span
                  key={topic}
                  className="px-3 py-1 bg-slate-100 text-slate-600 rounded text-xs font-medium border border-slate-200 cursor-pointer hover:bg-[#F5C344]/10 transition"
                >
                  {topic}
                </span>
              ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16 items-start">
            ...
            <div className="space-y-8">
              <div>
                ...
                />
                <h3 className="font-['Newsreader',serif] text-xl text-white italic">
                  JESAM
                </h3>
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap items-center gap-6 grayscale opacity-50 hover:grayscale-0 hover:opacity-100 transition-all duration-500">
                  <img
                    src="/logos/Clarivate Analytics Web of Science logo.png"
                    alt="Web of Science"
                    className="h-6 w-auto"
                  />
                  <img
                    src="/logos/Elsevier Scopus logo.png"
                    alt="Scopus"
                    className="h-6 w-auto"
                  />
                  <img
                    src="/logos/Contrimetric Logo.png"
                    alt="Contrimetric"
                    className="h-6 w-auto"
                  />
                </div>
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-5 text-sm">
                ...
                <li className="flex items-center gap-4 group">
                  ...
                  <a
                    href="mailto:jesam.uplb@up.edu.ph"
                ...
                <li className="flex items-center gap-4 group">
                  ...
                  <a
                    href="https://facebook.com/uplbjesam/"
                    target="_blank"
            ...
            <div className="flex flex-col md:items-end space-y-8 md:text-right">
              <div className="space-y-4">
                ...
                <p className="text-sm leading-relaxed max-w-xs text-white/50">
                  ...
                  scientific excellence and policy dialogue in line with the
